...
echo "========================================"
echo "Building OmniPacker for macOS ARM64"
...
echo "Modifying tauri.conf.json to only include macos-arm64 resources..."
python3 -c "
import json
with open('$CONFIG_FILE', 'r') as f:
    config = json.load(f)
config['bundle']['resources'] = ['binaries/macos-arm64/*']
