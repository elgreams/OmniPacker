...
echo "========================================"
echo "Building OmniPacker for macOS x64"
...
echo "Modifying tauri.conf.json to only include macos-x64 resources..."
python3 -c "
import json
with open('$CONFIG_FILE', 'r') as f:
    config = json.load(f)
config['bundle']['resources'] = ['binaries/macos-x64/*']
