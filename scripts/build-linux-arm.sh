...
echo "========================================"
echo "Building OmniPacker for Linux ARM"
...
echo "Modifying tauri.conf.json to only include linux-arm resources..."
python3 -c "
import json
with open('$CONFIG_FILE', 'r') as f:
    config = json.load(f)
config['bundle']['resources'] = ['binaries/linux-arm/*']
...
echo "Build complete!"
echo "Artifacts:"
echo "  AppImage: src-tauri/target/arm-unknown-linux-gnueabihf/release/bundle/appimage/"
echo "  Deb: src-tauri/target/arm-unknown-linux-gnueabihf/release/bundle/deb/"
echo "========================================"
