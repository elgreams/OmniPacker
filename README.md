...
| Platform | Download |
|----------|----------|
| Windows (Installer) | [Setup.exe](https://github.com/elgreams/OmniPacker/releases/download/v1.2.0/OmniPacker-1.2.0.amd64.Windows.Setup.exe) |
| Windows (Portable) | [Portable.zip](https://github.com/elgreams/OmniPacker/releases/download/v1.2.0/OmniPacker-1.2.0.amd64.Windows.Portable.zip) |
| Linux (AppImage) | [AppImage](https://github.com/elgreams/OmniPacker/releases/download/v1.2.0/OmniPacker-1.2.0.amd64.Linux.AppImage) |
