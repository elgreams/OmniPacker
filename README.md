...
| Platform | Download |
|----------|----------|
| Windows (Installer) | [Setup.exe](https://github.com/elgreams/OmniPacker/releases/download/v1.3.2/OmniPacker-1.3.2.amd64.Windows.Setup.exe) |
| Windows (Portable) | [Portable.zip](https://github.com/elgreams/OmniPacker/releases/download/v1.3.2/OmniPacker-1.3.2.amd64.Windows.Portable.zip) |
| Linux (AppImage) | [AppImage](https://github.com/elgreams/OmniPacker/releases/download/v1.3.2/OmniPacker-1.3.2.amd64.Linux.AppImage) |
| macOS (Apple Silicon) | [dmg](https://github.com/elgreams/OmniPacker/releases/download/v1.3.2/OmniPacker-1.3.2.arm64.MacOS.dmg) |
